...
<section class="categoryproducts">
	<div class="pos_title">
		...
		<p class="des-title">{l s='Commodo sociosqu venenatis cras dolor sagittis integer luctus sem primis eget maecenas sed urna malesuada consectetuer ' d='Shop.Theme.Catalog'}</p>
    </div>
